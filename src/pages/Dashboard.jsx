								...
								<table className="w-full text-base text-left text-gray-500">
									<thead className="bg-white">
										<tr className="border-b border-gray6 text-tiny">
											...
											<th
												scope="col"
												className="px-3 py-3 text-tiny text-text2 uppercase font-semibold w-14"
											>
												Action
											</th>
										</tr>
								...
								<div className="w-[250px]">
									<form action="#">
										<div className="w-[250px] relative">
											<input
												className="input h-9 w-full pr-12"
												type="text"
								...
								<table className="w-full text-base text-left text-gray-500">
									<thead className="bg-white">
										<tr className="border-b border-gray6 text-tiny">
											...
											<th
												scope="col"
												className="px-3 py-3 text-tiny text-text2 uppercase  font-semibold w-[14%] 2xl:w-[12%]"
											>
												Action
											</th>
										</tr>
											...
											>
												...
												<td className="px-3 py-3">
													<div className="flex items-center space-x-2">
														<button className="bg-success hover:bg-green-600 text-white inline-block text-center leading-5 text-tiny font-medium pt-2 pb-[6px] px-4 rounded-md">
